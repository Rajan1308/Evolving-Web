...
import menuitemLink from './footer-link/footer-link.twig';
...
import menuitemLinkData from './footer-link/footer-link.yml';
...
export const menuItems = () => (
  <div dangerouslySetInnerHTML={{ __html: menuitemLink(menuitemLinkData) }} />
);
export const social = () => (
