                ...
                <div class="container-fluid">
                    ...
                    <?php if(!empty($header_top_button)){?>
                        ...
                        <div class="search-content">
                            <form id="searchform" method="get" action="<?php echo esc_url( home_url( '/blog' ) ); ?>">
                                <input type="text" class="search-field form-control" name="keyword" placeholder="Search" value="<?php echo get_search_query(); ?>">
